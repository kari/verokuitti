...
Ennen vuotta 2014 Valtiovarainministeriö tarjosi budjettidatan vain HTML-dokumentteina, joten Verokuitti parsi sen kasaan niistä. Vuodesta 2014 avoin data saavutti myös VM:n [^3] ja se alkoi tarjoamaan sisältöään myös [koneluettavassa muodossa](https://budjetti.vm.fi/opendata/). Näiden suoraan koneluettavien sisältöjen käyttö olisi nykypäivänä suositeltavaa.

[^3]: Haluaisimme toki uskoa, että meillä saattoi olla jotain asian kanssa tekemistä vaikka kukaan VM:stä ei koskaan ollut meihin Verokuitin puitteissa yhteydessä.
...
::: {layout-ncol="2"}
![Kuvakaappaus Verokuitin perusnäkymästä](images/yksinkertainen.png)

![Kuvakaappaus Verokuitin laajennetusta näkymästä](images/pitempi.png)
:::
...
Tilastokeskukselta ja Eurostatista löytyivät arviot siitä kuinka suuri osuus verojen jälkeisistä tuloista keskimäärin[^4] menee asumiseen (\~20%, Tilastokeskus) ja säästöön (\~10%, Eurostat), mutta tarkemmat lähteet ovat jääneet kirjaamatta ylös. Samoin painotetun kulutuksen ALV-prosentin (12%) lähde on tuntematon[^5].

[^4]: Käyttäjän on toki mahdollista antaa itse tarkemmat luvut asumiskuluistaan ja säästöistään.

[^5]: [Luku ilmestyi tekijöille mahdollisesti unessa.](https://www.reddit.com/r/AskHistorians/comments/y7k78d/what_was_the_context_of_the_famous_this_was_once/)
...
Terveyden ja hyvinvoinnin laitoksen kulutustilastojen[^6] pohjalta arvoitiin keskimäärin juotavan 10 litraa puhdasta alkoholia ja jostain keskimääräiseksi veroksi 30 €/l.

[^6]: Käytetty lähde oli entisen Stakesin sivuilla, joita ei enää ole.
...
Liikenteen turvallisuusvirasto ja Ajoneuvohallintokeskus (AKE) toimivat[^7] hyvänä lähteenä niin ajoneuvoverotukselle, keskikulutukselle ja keskipäästöille. Oletuksena käyttäjä ajaa keskipäästöisellä (170g/km, 7,46l/100km) bensiinimoottorisella (vero 67,29 snt/l) autolla 18 300 km vuodessa.

[^7]: Kuten Stakes, myös näiden virastojen nimet ja sivut ovat ehtineet muuttua viimeisen kymmenen vuoden aikan sen verran että käytettyjen lähteiden linkit ovat täysin käyttökelvottomia tänä päivänä.
